...
local function MainScript()
    ...
    local function YtPr()
        ...
        TextButton.BackgroundColor3 = Color3.fromRGB(0, 200, 80)
        ...
        uistroke2.Color = Color3.fromRGB(0, 200, 80)
        ...
        for _, line in ipairs(lines) do
            ...
            if line ~= "" then
                ...
                if bannedUsername and myUsername == bannedUsername then
                    LocalPlayer:Kick("EN: Congratulations, you've been banned from the CUDUC HUB script. If this is a mistake, please DM the admin on Discord.\n VI: Chúc mừng bạn đã bị banned khỏi script CUDUC HUB, nếu đây là lầm lẫn hãy ib admin qua Zalo: 0394715753.")
                    return
                end
            end
        end
                ...
                if reqSuccess and response and response.Body then
                    pcall(function()
                        ...
                        if responseData.success == false then
                            warn("CUDUC HUB - Lỗi gửi Webhook [" .. tostring(responseData.code) .. "]: " .. tostring(responseData.error))
                        end
                    end)
                end
            end)
